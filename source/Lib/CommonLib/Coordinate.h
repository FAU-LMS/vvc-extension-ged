...
typedef Eigen::Array<int, 1, 2> Array2Fixed;
...
namespace FloatingFixedConversion {
  ...
  Array2TCoord fixedToFloating(const Array2Fixed &fixed, int precision);
  ...
  Array2Fixed floatingToFixed(const Array2TCoord &floating, int precision);
